...
function getCurrentPageFromHash() {
    ...
    if (hash === '' || hash === 'home' || hash === 'categories' || hash === 'podcastSearch' || hash === 'randomPodcast' || hash === 'favorites' || hash === 'login' || hash === 'register') return hash;
    else return 'home';
}
...
.account-administration-deleteaccount-button {color:white;cursor:pointer;background-color:rgb(250, 35, 59);border:none;border-radius:14px;padding:7px 20px;font-size:16px;transition:all .3s ease-in-out;}
                    ...
                    <div class="account-administration-content"> 
                        ...
                        <div class="account-administration-my">
                            <div class="account-administration-my-content">
                                <h1 class="account-administration-my-title">\xdcber mich</h1>
                                <p class="account-administration-my-desc">Hier k\xf6nnen sie ihren Account Verwalten. (z.B L\xf6sch Funktion und viele weitere Funktionen stehen ihnen hier zur verf\xfcgung)</p>
                                ...
                                <div class="account-administration-my-contains-background">
                                    <div class="account-administration-mypassword-form">
                                        <h1 class="account-administration-mypassword-title">Passwort \xe4ndern</h1>
                                        ...
                                        <div class="account-administration-mypassword-inputs">
                                            ...
                                            <input class="account-administration-mypassword-input-newpasswordConfirm account-administration-mypassword-input" type="password" placeholder="Neues Passwort best\xe4tigen" name="newpasswordConfirm" required>
                                            <button class="account-administration-mypassword-button-password-change">Passwort \xe4ndern</button>
                                        </div>
                                    </div>
                                </div>
                                <button class="account-administration-deleteaccount-button" onclick="deleteAccount()">Account l\xf6schen</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form class="register-auth-form" method="POST">
                                 ...
                                 <div class="register-auth-form-inputs">
                                     ...
                                     <div class="register-auth-form-input-password-confirm-container input-container">
                                          <input class="register-auth-form-input-password-confirm" type="password" placeholder="Passwort best\xe4tigen" name="passwordConfirm">
                                     </div>
                                 </div>
            ...
            content = `
                <div class="random-podcast-main-container">
                    <div class="random-podcast-main-content">
                        ...
                        <p class="random-podcast-undertitle">Lass dir einen zuf\xe4lligen Podcast anzeigen um neue Podcasts zu entdecken.</p>
                        <button class="random-podcast-button" id="randomPodcastBtn" onclick="getRandomPodcast()" title="Zuf\xe4lliger Podcast Suchen">Zuf\xe4lliger Podcast Suchen</button>
                        ...
                        <div class="main-body-title-container">
                            ...
                            <div class="main-body-title-right-container">
                                <div class="back-to-category-container">
                                    <button class="back-to-category-button" href="#categorie" onclick="navigateTo('categories')"><i class="fa-solid fa-chevron-left" style="padding-right:5px;font-size:10px;"></i> Zur\xfcck zu Kategorien</button>
                                </div>
                            </div>   
                        </div>
            ...
            content = `
                <div class="main-body-container">
                    <div class="main-body-content">
                        <div class="main-body-title-container">
                            <div class="main-body-title-left-container">
                                <h1 class="main-body-title">Gesch\xe4ftsnachrichten Podcasts</h1>
                            </div>
                            <div class="main-body-title-right-container">
                                <div class="back-to-category-container">
                                    <button class="back-to-category-button" href="#categorie" onclick="navigateTo('categories')"><i class="fa-solid fa-chevron-left" style="padding-right:5px;font-size:10px;"></i> Zur\xfcck zu Kategorien</button>
            ...
            content = `
                <div class="main-body-container">
                    <div class="main-body-content">
                        <div class="main-body-title-container">
                            <div class="main-body-title-left-container">
                                <h1 class="main-body-title">Sexualit\xe4t Podcasts</h1>
                            </div>
                            <div class="main-body-title-right-container">
                                <div class="back-to-category-container">
                                    <button class="back-to-category-button" href="#categorie" onclick="navigateTo('categories')"><i class="fa-solid fa-chevron-left" style="padding-right:5px;font-size:10px;"></i> Zur\xfcck zu Kategorien</button>
    ...
    `;
            ...
            fetch('https://webengineering.ins.hs-anhalt.de:10062/auth/isLoggedIn', {
                ...
                <div class="no-favorites-list-container">
                    ...
                    <p class="no-favorites-list-undertitle">Sie m\xfcssen eingeloggt sein, um Ihre Favoriten zu sehen. Bitte melden Sie sich an.</p>
                </div>
            `;
                    return;
                }
            ...
            }).then((response)=>response.json()).then((favoriteData)=>{
                if (!favoriteData || favoriteData.length === 0) {
                    document.getElementById('app').innerHTML = `
                <div class="no-favorites-list-container">
                    <h1 class="no-favorites-list-title">Meine Favoriten</h1>
                    <p class="no-favorites-list-undertitle">Derzeit haben Sie keine Favoriten. Besuchen Sie einen Podcast und f\xfcgen Sie ihn zu Ihren Favoriten hinzu.</p>
                </div>
            `;
                    return;
                }
        ...
        `;
                const fetchImagePromises = favoriteData.map((favorite)=>{
                    return fetch(`https://api.fyyd.de/0.2/podcast?podcast_id=${favorite.podcastId}`).then((response)=>response.json()).then((data)=>{
                        ...
                        console.error(`Fehler beim Abrufen des Bildes f\xfcr Podcast ${favorite.podcastId}:`, error);
                        return {
                            ...favorite,
                            imageUrl: 'default-image.jpg'
                        }; // Fehlerfall: Standardbild
                    });
                });
                Promise.all(fetchImagePromises).then((updatedFavorites)=>{
                    ...
                    <li class="favorite-item">
                        ...
                        <button class="remove-button" title="Podcast aus der Favoriten Liste l\xf6schen" data-id="${favorite.podcastId}">x</button>
                    </li>
                `;
                    });
                    content += `</ul></div>`;
            ...
            break;
        case 'podcastDetail':
            if (!podcastData) content = generateHomePageContent();
            else {
                // DOMContentLoaded-Event-Listener hinzufügen
                document.addEventListener('DOMContentLoaded', ()=>{
                    renderEpisodes();
                });
                let description = podcastData.description ? podcastData.description : "Keine Beschreibung ist bei dem Podcast verf\xfcgbar.";
    ...
    if (page === 'register') setRegisterFormListener();
    if (page === 'login') setLoginFormListener();
    // Funktion geht wenn man auf der Account Verwaltung ist
    if (page === 'account-administration') {
        loadProfileData();
        setPasswordChangeFormListener();
    }
    if (page === 'podcastDetail' && podcastData) renderEpisodes(podcastData);
                ...
                <div class="main-body-main_page-container">
                    <div class="main-body-main_page-content">
                        ...
                        <div class="main-body-main_page-categories-help-container">
                            <h1 class="main-body-main_page-categories-help-title">Kategorien Vorschl\xe4ge</h1>
                            <div class="main-body-main_page-categories-help-content">
                                <ul class="main-body-main_page-categories-help-list">
                                    ...
                                    <li class="main-body-main_page-categories-help-listitem" href="#category-business-news" onclick="navigateTo('category-business-news')">
                                        <a class="main-body-main_page-categories-help-listitem-container">
                                            <h1 class="main-body-main_page-categories-help-listitem-title">Gesch\xe4ftsnachrichten</h1>
                                            <i class="main-body-main_page-categories-help-listitem-icon fa-solid fa-chevron-right"></i>
                                        </a>
                                    </li>
...
//# sourceMappingURL=public.425655e8.js.map
