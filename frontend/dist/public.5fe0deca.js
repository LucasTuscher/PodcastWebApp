async function isFavoritesLogged(podcastId) {
    try {
        ...
        const container1 = document.querySelector('.podcastdetail-right-content.under-right-container');
        container1.innerHTML = ''; // Container leeren
        if (!loginResponse.ok) {
        ...
        if (!favoriteResponse.ok) {
            ...
            container1.innerHTML = `<p>Fehler beim \xdcberpr\xfcfen der Favoriten.</p>`;
            return;
        }
...
//# sourceMappingURL=public.5fe0deca.js.map
